...
<!-- Use this file to provide workspace-specific custom instructions to Gemini. -->
...
- I will be direct and concise in my communication.
- I will use the available tools to perform actions.
- I will present code changes clearly.
